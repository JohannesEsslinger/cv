...
\cvline{\en{}\de{geboren}}{\en{
    I am seeking a machine learning internship where I can leverage my strong mathematical and programming skills. 
    As an ambitious and self-motivated individual, I have been passionate about programming from a young age. 
    I vividly recall eagerly perusing my father's old C programming books and attempting to grasp their content. 
    My intrinsic curiosity regarding new technologies has persisted ever since, which is why I am enthusiastic about 
    contributing to innovative projects and gaining practical experience in the field of machine learning.
...
\cvcomputer{\en{Languages}\de{Sprachen}}{Python, Java, C\#, SQL}{\en{Technologies}\de{Technologien}}{Linux, NumPy, Pandas, PyTorch, Git, .Net-Framework, Snowflake}
