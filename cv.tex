...
\cvlistitem{\textbf{\en{Further contributions}\de{Weitere Beiträge}}: \\
            ...
            mamba (\link{https://github.com/mamba-org/mamba/pull/1781}
            {\en{Added support for deinitializing the micromamba client}\de{Deinitialisierung des Micromamba-Clients hinzugefügt}})}
