...
\social[linkedin][linkedin.com/in/zwerschke/]{Pavel Zwerschke}
...
\cventry{2021-\en{today}\de{heute}}
        ...
        {}
        {}
        {\en{German grade average: 1.1}\de{Durchschnittsnote: 1,1}}
\cventry{2021-\en{today}\de{heute}}
        {\en{Karlsruhe Institute of Technology (KIT)}\de{Karlsruher Institut für Technologie (KIT)}}
        ...
        {}
        {\en{German grade average: 1.1}\de{Durchschnittsnote: 1,1}}
\cventry{09.2022-01.2023}
        {\en{Radboud University Nijmegen}\de{Radboud Universität Nijmegen}}
        {\en{Exchange student Computing Science}\de{Austauschstudent Informatik}}
        {}
        {}
        {}
\cventry{2018-2021}
        ...
        {}
        {}
        {\en{German grade average: 1.0 (with distinction)}\de{Durchschnittsnote: 1,0 (mit Auszeichnung)}\\
        Thesis:
        \en{\quotes{Nonparametric Distributional Regression Models for Probabilistic Energy Forecasting}}
        \de{\quotes{Nonparametric Distributional Regression Models for Probabilistic Energy Forecasting}}\\
        \en{Recipient of the Faculty Award for excellent performance (best of the year)}
        \de{Empfänger des Fakultätspreises für hervorragende Leistungen (bester des Jahrgangs)}}
\cventry{2019-2021}
        {\en{Karlsruhe Institute of Technology (KIT)}\de{Karlsruher Institut für Technologie (KIT)}}
...
\cventry{04.2022-\en{today}\de{heute}}
        ...
        I also contributed to \link{https://github.com/mamba-org/mamba}{mamba}, a cross-platform package manager written in C++.}
        ...
        Außerdem habe ich bei \link{https://github.com/mamba-org/mamba}{mamba} mitgearbeitet, einem cross-platform Paketmanger, der in C++ geschrieben ist.}}
\cventry{2021-2022}
        {\en{Karlsruhe Institute of Technology (KIT)}\de{Karlsruher Institut für Technologie (KIT)}}
...
\cvlistitem{\link{https://github.com/pavelzw/7circles}{\textbf{7circles}}: 
            \en{An educational video created with manim about the Seven Circles Theorem. The video is available on YouTube in \link{https://youtu.be/m9v0h2ibYpo}{English} and in \link{https://youtu.be/flR3e5Cc2G4}{German}.}
            \de{Ein mit manim animiertes Video über den Sieben Kreise Satz. Das Video ist auf YouTube auf \link{https://youtu.be/m9v0h2ibYpo}{Englisch} und auf \link{https://youtu.be/flR3e5Cc2G4}{Deutsch} verfügbar.}}
...
\cvlistitem{\textbf{\en{Further contributions}\de{Weitere Beiträge}}: \\
            ...
            mamba (\link{https://github.com/mamba-org/mamba/pulls?q=is\%3Apr+author\%3Apavelzw+}
            {\en{Added support for deinitializing micromamba, build systems}\de{Deinitialisierung von micromamba hinzugefügt, Buildsysteme}})}
